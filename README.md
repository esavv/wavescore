...
```bash  
ssh -i "src/esavage_ec2.pem" ubuntu@ec2-44-210-82-47.compute-1.amazonaws.com
```
...
```bash  
scp -i esavage_ec2.pem -r src.zip ubuntu@ec2-44-210-82-47.compute-1.amazonaws.com:/home/ubuntu/wavescore/src
```
...
```bash  
scp -i ../src/esavage_ec2.pem -r data.zip ubuntu@ec2-44-210-82-47.compute-1.amazonaws.com:/home/ubuntu/wavescore/data
```
   - Copy model and training log from EC2 instance back to local project; run this locally
```bash  
scp -i esavage_ec2.pem ubuntu@ec2-44-210-82-47.compute-1.amazonaws.com:'/home/ubuntu/wavescore/models/surf_maneuver_model_20250518_1431.pth' ../models/
scp -i esavage_ec2.pem ubuntu@ec2-44-210-82-47.compute-1.amazonaws.com:'/home/ubuntu/wavescore/logs/training_20250518_1431.log' ../logs/
```
